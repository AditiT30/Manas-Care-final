...
import StudentLoginButton from "../../../../components/Login/student-login-button";
            ...
            <div className="lg:w-1/2 bg-gradient-to-br from-[#009379] to-teal-900 text-white p-6 lg:p-12 flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-lg lg:text-xl mb-8 lg:mb-12 opacity-90 leading-relaxed">
                        Join thousands of students who are prioritizing their mental health while navigating academic life.
                    </p>
                    ...
                    <div className=" bg-opacity-20 rounded-2xl p-6 lg:p-8 backdrop-blur-sm">
                        <div className="flex items-center mb-4">
                            ...
                            <h3 className="text-xl font-semibold">Student Benefits</h3>
                        </div>
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                'Mind Vault - Personalized stress management tools',
                ...
                <div className="max-w-md mx-auto w-full">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 text-sm lg:text-base">
                            Your mental wellness journey starts here. Access tools designed specifically for your academic experience.
                        </p>
                    </div>
